...
const DarkMode: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-10 h-5 bg-blue-200 rounded-full px-0.5 dark:bg-green-700/[.3] relative flex items-center dark:justify-end">
        <div className="w-4 h-4 rounded-full bg-blue-600 absolute"></div>
      </div>
    </button>
  );
};
